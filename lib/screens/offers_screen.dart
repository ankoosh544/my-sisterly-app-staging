...
class OffersScreenState extends State<OffersScreen>  {
  ...
  getOffers(nextPage) {
    ...
    ApiManager(context).makeGetRequest(_mode == OffersScreenMode.received ? "/product/order/received" : "/product/order/made", { "count": _pageSize, "mode": "offers", "start": nextPage ? _offers.length : 0 }, (res) {
      if(!nextPage) {
        _offers = [];
      }
